...
const (
	FileTypeEnumImage FileTypeEnum = iota + 1 // 图片
	FileTypeEnumVideo                         // 视频
	FileTypeEnumAudio                         // 音频
	FileTypeEnumFile                          // 文件
)
...
type (
	...
	Attachment   struct {
		...
		FileType             FileTypeEnum    `json:"file_type" gorm:"column:file_type;type:int;not null"`                                   // 文件类型
